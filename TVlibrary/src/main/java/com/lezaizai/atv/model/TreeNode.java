package com.lezaizai.atv.model;

import android.content.Context;
import android.view.View;
import android.view.ViewGroup;

import com.lezaizai.atv.R;
import com.lezaizai.atv.view.AndroidTreeView;
import com.lezaizai.atv.view.TreeNodeWrapperView;
...
public class TreeNode {
    ...
    public TreeNode addChild(int index, TreeNode childNode) {
        childNode.mParent = this;
        childNode.mId = generateId();
    ...
    public static abstract class BaseNodeViewHolder<E> {
        ...
        private View mView;
        protected int containerStyle = 0;
